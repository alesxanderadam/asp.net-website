<%@ Page Title="" Language="C#" MasterPageFile="~/home-view/Home.master" AutoEventWireup="true" CodeFile="home-latest.aspx.cs" Inherits="home_view_home_latest" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <div class="container-fluid">
                <div class="container">
                    <nav class="breadcrumb bg-transparent m-0 p-0">
                        ...
                        <asp:Label ID="Label5" runat="server" CssClass="breadcrumb-item active" Text="Bảng tin mới nhất"></asp:Label>
                    </nav>
                </div>
            </div>
            <!-- Breadcrumb End -->
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="d-flex align-items-center justify-content-between bg-light py-2 px-4 mb-3">
                                        <asp:Label ID="Label1" runat="server" CssClass="m-0" Text="Bảng tin nóng trong ngày" Font-Bold="true" Font-Size="X-Large"></asp:Label>                            
                                    </div>
                                </div>
                                                    ...
                                                    <ul class="pagination justify-content-center">
                                                        <asp:DataPager ID="DataPager1" runat="server" PageSize="6" PagedControlID="ListView1" Class="pagination justify-content-center">
                                                            <Fields>
                                                                ...
                                                                <asp:NumericPagerField ButtonType="Link" CurrentPageLabelCssClass="page-item acti page-link font-weight-bold " NumericButtonCssClass="page-item page-link font-weight-bold" NextPreviousButtonCssClass="page-item page-link" />
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Pixel_AdminConnectionString3 %>" SelectCommand="select top 1 [Blog].id, [Blog].name, [Blog].title, [Blog].description, [Category].name as category_id, [Blog].updated_at,[Blog].image FROM [Blog] INNER JOIN [Category] ON [Blog].category_id = [Category].id ORDER BY [updated_at] DESC">
        <%--<SelectParameters>
            <asp:QueryStringParameter Name="id" QueryStringField="id" Type="Int32" />
        </SelectParameters>--%>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:Pixel_AdminConnectionString3 %>" SelectCommand="select [Blog].id, [Blog].name, [Blog].title, [Blog].description, [Category].name as category_id, [Blog].updated_at,[Blog].image FROM [Blog] INNER JOIN [Category] ON [Blog].category_id = [Category].id ORDER BY [updated_at] DESC">
        <%--<SelectParameters>
            <asp:QueryStringParameter Name="id" QueryStringField="id" Type="Int32" />
        </SelectParameters>--%>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:Pixel_AdminConnectionString3 %>" SelectCommand="select top 4 [Blog].id, [Blog].name, [Blog].title, [Blog].description, [Category].name as category_id, [Blog].updated_at,[Blog].image FROM [Blog] INNER JOIN [Category] ON [Blog].category_id = [Category].id ORDER BY [updated_at] DESC">
        <%--<SelectParameters>
            <asp:QueryStringParameter Name="id" QueryStringField="id" Type="Int32" />
        </SelectParameters>--%>
    </asp:SqlDataSource>
